...
La finalidad de este proyecto es el de hacer una interfaz gráfica de usuario para aplicaciones Java con las siguientes características:
...
La interfaz gráfica guia al usuario por medio de las distintas funcionalidades de la aplicación y
le muestra solo la información que le resulte relevante.

A su vez, la aplicación en caso de necesidad, dispone de una ayuda desarrollada con JavaHelp
que explicará al usuario con al menos 5 HTML las funcionalidades básicas de la aplicación
...
Esta aplicación, además del sistema de reserva de castillos, dispone de un juego opcional que, en caso de superar, dará al usuario la opción de obtener un descuento para alguna de sus próximas reservas. Este descuento se se guardará por medio de su dni. 
...
Las reglas del juego están explicadas en la propia aplicación pero se resumen en un tablero lleno de fantasmas y un dado que dictamina los movimientos. En función de los fantasmas eliminados en el tablero, el usuario obtendrá o no descuento y en caso de obtenerlo, será mayor o menor en función del mismo parámetro.

En caso de haber obtenido descuento este se podrá guardar por medio de un DNI, el cual se debe aportar tambien en el momento de la reserva.

## Detalles y Limitaciones

- La barra de busqueda de hoteles funciona únicamente introduciendo el nombre completo del hotel que se quiere buscar
